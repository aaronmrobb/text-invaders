...
/***/ function(module, exports, __webpack_require__) {
	...
	var _textinvaders = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./reducers/textinvaders.js\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));

	var _textinvaders2 = _interopRequireDefault(_textinvaders);
	...
	var store = (0, _redux.createStore)(_textinvaders2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsWarning = __webpack_require__(170);
	...
	var Game = function (_Component) {
	  ...
	  _createClass(Game, [{
	    ...
	    value: function render() {
	      ...
	      var board = store.getState().game.board;
	      return _react2.default.createElement(
	        'div',
	        { className: 'game' },
	  ...
	  _createClass(Board, [{
	    ...
	    value: function render() {
	      ...
	      board.map(function (row, index) {
	        rows.push(_react2.default.createElement(_row2.default, { cells: row, key: index }));
	      });
	      return _react2.default.createElement(
	        'div',
	        { className: 'board' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Form = function (_Component) {
	  ...
	  _createClass(Form, [{
	    key: "shootWord",
	    value: function shootWord() {}
	  }, {
	    key: "render",
	    value: function render() {
	      return _react2.default.createElement(
	        "form",
	        { autoComplete: "off", className: "turret", onSubmit: this.shootWord.bind(this) },
	        _react2.default.createElement("input", { id: "gun", ref: "input", placeholder: "Shoot shit" })
	      );
	    }
	  }]);
	...
	var Row = function (_Component) {
	  ...
	  _createClass(Row, [{
	    ...
	    value: function render() {
	      ...
	      var words = [];
	      cells.map(function (word, index) {
	        words.push(_react2.default.createElement(_cell2.default, { content: word, key: index }));
	      });
	      return _react2.default.createElement(
	        'div',
	        { className: 'row' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Cell = function (_Component) {
	  ...
	  function Cell(props) {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Cell).call(this, props));
	  }
